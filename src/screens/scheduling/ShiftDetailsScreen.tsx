    ...
    <div className="min-h-screen bg-pink-gradient">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <button
                onClick={() => navigate('/shift-calendar')}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Shift Details</h2>
          <p className="text-gray-600">Individual shift details coming soon.</p>
        </div>
      </div>
    </div>
  );
